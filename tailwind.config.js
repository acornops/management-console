  ...
  theme: {
    extend: {
      colors: {
        ...
        'control-primary': 'rgb(var(--control-primary-bg-rgb) / <alpha-value>)',
        'control-primary-hover': 'rgb(var(--control-primary-hover-rgb) / <alpha-value>)',
        'control-primary-fg': 'rgb(var(--control-primary-fg-rgb) / <alpha-value>)',
        'control-secondary': 'rgb(var(--control-secondary-bg-rgb) / <alpha-value>)',
        'control-secondary-hover': 'rgb(var(--control-secondary-hover-rgb) / <alpha-value>)',
        'control-secondary-fg': 'rgb(var(--control-secondary-fg-rgb) / <alpha-value>)',
        'control-activation': 'rgb(var(--control-activation-bg-rgb) / <alpha-value>)',
        'control-activation-hover': 'rgb(var(--control-activation-hover-rgb) / <alpha-value>)',
        'control-activation-fg': 'rgb(var(--control-activation-fg-rgb) / <alpha-value>)',
        'control-danger': 'rgb(var(--control-danger-bg-rgb) / <alpha-value>)',
        'control-danger-hover': 'rgb(var(--control-danger-hover-rgb) / <alpha-value>)',
        'control-danger-fg': 'rgb(var(--control-danger-fg-rgb) / <alpha-value>)',
        'control-boundary': 'rgb(var(--control-boundary-rgb) / <alpha-value>)',
        ...
        'code-text': 'rgb(var(--code-text-rgb) / <alpha-value>)'
      },
      fontFamily: {
