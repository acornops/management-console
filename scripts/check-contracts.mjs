...
for (const [docPath, implNeedle, label] of [
  ...
  ['`POST /api/v1/workspaces/{workspaceId}/targets/{targetId}/mcp/servers/{serverId}/connection/oauth/prepare`', 'prepareTargetMcpOAuth(', 'Target MCP OAuth preparation implementation'],
  ['`POST /api/v1/workspaces/{workspaceId}/targets/{targetId}/mcp/servers/{serverId}/connection/oauth/start`', 'startTargetMcpOAuth(', 'Target MCP OAuth start implementation'],
  ...
  ['`POST /api/v1/workspaces/{workspaceId}/targets/{targetId}/skills/resolve`', 'resolveTargetGitSkill(', 'Resolve target Git skill implementation'],
  ...
  ['`POST /api/v1/workspaces/{workspaceId}/agents/{agentId}/mcp/servers/{serverId}/connection/oauth/prepare`', 'prepareAgentMcpOAuth(', 'Agent MCP OAuth preparation implementation'],
  ['`POST /api/v1/workspaces/{workspaceId}/agents/{agentId}/mcp/servers/{serverId}/connection/oauth/start`', 'startAgentMcpOAuth(', 'Agent MCP OAuth start implementation'],
  ['`GET /api/v1/workspaces/{workspaceId}/agents/{agentId}/skills`', 'listAgentSkills(', 'List Agent skills implementation'],
  ['`POST /api/v1/workspaces/{workspaceId}/agents/{agentId}/skills/resolve`', 'resolveAgentGitSkill(', 'Resolve Agent Git skill implementation'],
