...
export const AppDesktopSidebarHeader: React.FC<AppDesktopSidebarHeaderProps> = ({
  ...
  return (
    <div className={`flex items-center ${collapsed ? 'flex-col gap-1 px-3 py-3' : 'justify-between gap-2 px-4 py-5'}`}>
      <Button variant="tertiary" size="inline" className="control-target flex min-h-10 min-w-10 cursor-pointer items-center gap-3" onClick={() => navigate(homePath)} aria-label={t('app.goHome')}>
