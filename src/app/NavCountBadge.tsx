...
export const NavCountBadge: React.FC<NavCountBadgeProps> = ({ count, compact = false }) => {
  ...
  return (
    <span
      ...
      className={compact
        ? 'inline-flex h-4 min-w-4 shrink-0 items-center justify-center rounded-full bg-status-danger px-0.5 type-micro-label leading-none tabular-nums text-ui-bg'
