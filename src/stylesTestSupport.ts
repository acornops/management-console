...
export const workspaceIncomingWebhooksPage = readSource('src/pages/WorkspaceIncomingWebhooksPage.tsx');
export const webhookList = readSource('src/features/webhooks/WebhookList.tsx');
export const workspaceActivityPage = readSource('src/pages/WorkspaceActivityPage.tsx');
