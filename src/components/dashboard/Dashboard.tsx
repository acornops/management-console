...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  const handleConfirmDeleteCluster = async () => {
    if (!deleteTargetCluster || !onDeleteKubernetesCluster || isDeletingCluster || deleteClusterConfirmation !== deleteTargetCluster.name) {
      return;
    }
            ...
            <div className="flex items-center justify-between border-b border-ui-border bg-ui-bg px-7 py-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 type-caption">{t('dashboard.deleteClusterSubtitle')}</p>
                </div>
              </div>
