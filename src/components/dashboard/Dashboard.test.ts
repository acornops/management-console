...
describe('cluster catalog and inspector layout', () => {
  it('uses a restrained inventory summary modeled after target inventory surfaces', () => {
    ...
    expect(dashboard).not.toContain('hasUnloadedClusters');
    expect(dashboard).not.toContain('loadedClusterInventoryBody');
  ...
  it('removes chart-card telemetry loading from the catalog page', () => {
    ...
    expect(kubernetesClustersPage).toContain('updateCatalogState({ selectedClusterId: undefined });');
    ...
    expect(kubernetesClustersPage).toContain('onAppendWorkspaceKubernetesClusters?.(workspaceId, livePageItems);');
    expect(kubernetesClustersPage).toContain('onDeleteKubernetesCluster={onDeleteKubernetesCluster ? handleDeleteKubernetesCluster : undefined}');
