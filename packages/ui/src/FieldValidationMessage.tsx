...
export const FieldValidationMessage: React.FC<{ id: string; message?: string }> = ({ id, message }) => {
  ...
  return (
    <p id={id} role="alert" className="type-caption mt-2 flex items-start gap-2 rounded-md border border-status-danger/25 bg-status-danger-soft px-3 py-2 font-semibold leading-5 text-status-danger-text">
